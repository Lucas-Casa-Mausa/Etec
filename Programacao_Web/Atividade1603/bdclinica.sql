...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Mar-2023 às 01:47
...
CREATE TABLE `tbmedico` (
  ...
  `nomeMedico` varchar(35) NOT NULL,
...
CREATE TABLE `tbpaciente` (
  ...
  `celPaciente` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `tbagendamento`
  ...
  ADD KEY `fkcodcliente` (`codPaciente`),
...
ALTER TABLE `tbagendamento`
  ...
  ADD CONSTRAINT `fkcodcliente` FOREIGN KEY (`codPaciente`) REFERENCES `tbpaciente` (`codPaciente`);
